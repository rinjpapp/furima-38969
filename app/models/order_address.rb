class OrderAddress
  ...
  def save
    ...
    AddressList.create(post_code: post_code, prefecture_id: prefecture_id, city: city, address: address, building_name: building_name, phone_number: phone_number, order_record_id: order_record.id)
  end
