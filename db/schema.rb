...
ActiveRecord::Schema.define(version: 2023_03_09_063743) do
  ...
  create_table "address_lists", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["order_record_id"], name: "index_address_lists_on_order_record_id"
  end
  ...
  add_foreign_key "address_lists", "order_records"
